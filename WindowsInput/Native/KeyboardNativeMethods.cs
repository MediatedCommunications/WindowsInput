...
namespace WindowsInput.Native {
    public static class KeyboardNativeMethods {
        ...
        private static KeyboardState lastKeyState = KeyboardState.Blank();
        ...
        internal static bool TryGetCharFromKeyboardState(int virtualKeyCode, int scanCode, int fuState, IntPtr dwhkl, out char[] chars) {
            ...
            if (lastVirtualKeyCode != 0 && lastIsDead) {
                if (chars != null) {
                    ...
                    ToUnicodeEx(lastVirtualKeyCode, lastScanCode, lastKeyState.State, sbTemp, sbTemp.Capacity, 0, dwhkl);
                    lastIsDead = false;
        ...
        private static void ClearKeyboardBuffer(int vk, int sc, IntPtr hkl) {
            ...
            while (ToUnicodeEx(vk, sc, KeyboardState.Blank().State, sb, sb.Capacity, 0, hkl) < 0) { 
        ...
        /// </remarks>
        [DllImport("user32.dll")]
        public static extern int GetKeyboardState(KeyboardKeyState[] pbKeyState);
